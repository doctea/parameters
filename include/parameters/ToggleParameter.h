...
class ToggleParameter : public DataParameter<TargetClass,DataType> {
    ...
    //     // if (this->debug) {
    //         Serial.print(F("ToggleParameter#updateValueFromNormal(float of "));
    //         Serial.print(value);
    //         Serial.print(F(") about to call setParamValue(bool)")); Serial_flush();
    //     // }
    //     if (value>=0.5) {
    //         //if (this->debug) Serial.println("true!!");
    //         this->updateValueFromData((bool)true);
    //     } else {
    //         //if (this->debug) Serial.println("false!!");
    //         this->updateValueFromData((bool)false);
    //     }
    // }

    // virtual void updateValueFromData(bool value) override {
    ...
    //         (this->target->*setter_func)(this->currentDataValue);
    //     }
